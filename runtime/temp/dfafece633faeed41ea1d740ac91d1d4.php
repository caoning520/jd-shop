<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"C:\wamp64\wamp\www\jd-shop\public/../application/admin\view\category\index.html";i:1508685489;s:76:"C:\wamp64\wamp\www\jd-shop\public/../application/admin\view\Public\meta.html";i:1508483405;s:78:"C:\wamp64\wamp\www\jd-shop\public/../application/admin\view\Public\header.html";i:1490074809;s:76:"C:\wamp64\wamp\www\jd-shop\public/../application/admin\view\Public\menu.html";i:1508680544;s:78:"C:\wamp64\wamp\www\jd-shop\public/../application/admin\view\Public\footer.html";i:1508639064;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加分类','<?php echo url('cate_add'); ?>','400','300')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加分类</a></span> <span class="r">共有数据：<strong>88</strong> 条</span> </div>
			<div class="mt-20">
				<table class="table table-border table-bordered table-hover table-bg table-sort">
					<thead>
					<div id="test1">rer</div>
						<tr class="text-c">
							<th width="25"><input type="checkbox" name="" value=""></th>
							<th width="80">ID</th>
							<th width="100">分类名称</th>
							<th width="90">添加时间</th>
							<th width="130">上一次修改时间</th>
							<th width="70">状态</th>
							<th width="100">操作</th>
						</tr>
					</thead>
					...
					<?php if(is_array($categorys) || $categorys instanceof \think\Collection || $categorys instanceof \think\Paginator): $i = 0; $__LIST__ = $categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr class="text-c">
							...
							<td class="text-l">
							<?php echo str_repeat('---',$vo['level']); ?>&nbsp;<?php echo $vo['cate_name']; ?></td>
							<td class="text-l"><?php echo $vo['create_time']; ?></td>
							<td><?php echo $vo['update_time']; ?></td>
							<td class="td-status">
								<a href="<?php echo url('category/status', ['id'=>$vo['id'], 'status'=>$vo['status']==1?0:1]); ?>"><?php echo status($vo['status']); ?></a>
							</td>
							<td class="td-manage">
							 <a title="编辑" href="javascript:;" onclick="member_edit('编辑','<?php echo url('category/cate_edit', ['id'=>$vo['id']]); ?>','4','400','310')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>  
